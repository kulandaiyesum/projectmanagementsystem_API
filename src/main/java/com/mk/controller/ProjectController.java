...
import com.mk.request.InviteRequest;
import com.mk.response.MessageResponse;
import com.mk.service.InvitationService;
import com.mk.service.ProjectService;
...
public class ProjectController {
    ...
    public ResponseEntity<MessageResponse> deleteProject(
        ...
        MessageResponse res = new MessageResponse("project delete successfully");
    ...
    @PostMapping("/invite")
    public ResponseEntity<MessageResponse> invitePoject(
            @RequestHeader("Authorization") String jwt,
